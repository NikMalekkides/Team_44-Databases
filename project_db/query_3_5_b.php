...
<body>
    ...
    <div class="container my-5">
        <h2>Ανάμεσα σε ζεύγη πεδίων που είναι κοινά στα έργα, βρείτε τα 3 κορυφαία ζεύγη που εμφανίστηκαν σε έργα (με κριτήριο το πλήθος έργων).</h2>
        <table class="table">
            <thead>
                <tr>
                  <th>Πεδίο 1</th>
            ...
            <tbody>
                ...
                $sql = "SELECT field1, field2, COUNT(*) freq FROM field_pairs
