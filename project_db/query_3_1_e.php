...
<body>
    ...
    <div class="container my-5">
        <h2>Έργα με διάρκεια μικρότερη ή ίση απο <?php echo $_GET['id_3_1_e']; ?> έτη.</h2>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                $sql = "SELECT *, TRUNCATE(DATEDIFF(end_date,start_date)/365,2) duration FROM project
                        WHERE DATEDIFF(end_date,start_date)<=365*". $_GET['id_3_1_e'];
